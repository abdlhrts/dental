        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center lg:order-2">
                <button type="button" data-dropdown-toggle="language-dropdown-menu"
                    ...
                    <svg class="w-6 h-6 dark:hidden" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <svg class="w-6 h-6 hidden dark:block" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                        fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd"
                ...
                @auth
                <!-- Notifications -->
                <button type="button" x-data="{}" x-on:click="$dispatch('open-modal', { id: 'database-notifications' })"
                    class="p-2 mr-1 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
